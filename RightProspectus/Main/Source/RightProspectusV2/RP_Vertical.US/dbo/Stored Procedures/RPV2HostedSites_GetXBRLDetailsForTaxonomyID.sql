...
BEGIN
	...
	Declare @497DocumentType varchar(500)
	...
	SELECT TOP 1 @497FilingDate=EdgarXBRL.FilingDate,@497DocumentType=Edgar.DocumentType FROM EdgarXBRL 
	...
	IF @497FilingDate is not null
		BEGIN
			IF @ProFilingDate is null OR @497FilingDate > @ProFilingDate
	...
	ELSE
	   ...
	   IF @497DocumentType like '%revised%' and @ProFilingDate is not null
	   BEGIN
		SET @MinFilingDate = @ProFilingDate
	   END

...
BEGIN
	...
	FROM 
		TaxonomyAssociation TA 
			...
			RIGHT OUTER JOIN DocumentTypeAssociation SiteLevelDTA ON SiteLevelDTA.SiteId = @SiteID And SiteLevelDTA.IsProofing = @IsProofing
			LEFT OUTER JOIN DocumentTypeAssociation TALevelDTA ON TALevelDTA.TaxonomyAssociationID = TA.TaxonomyAssociationID And TALevelDTA.IsProofing = @IsProofing

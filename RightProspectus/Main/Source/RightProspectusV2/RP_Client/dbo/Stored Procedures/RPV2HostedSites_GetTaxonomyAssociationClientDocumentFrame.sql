...
BEGIN
	...
	BEGIN
		...
		INNER JOIN [dbo].[TaxonomyAssociation] CTA ON TAH.ChildTaxonomyAssociationId = CTA.TaxonomyAssociationID And CTA.IsProofing = @IsProofing
		INNER JOIN (
	...
	BEGIN
		INSERT INTO @TaxonomyAssociationIdsForSite
		SELECT DISTINCT TaxonomyAssociationId FROM TaxonomyAssociation WHERE SiteID = @SiteID And IsProofing = @IsProofing
	END

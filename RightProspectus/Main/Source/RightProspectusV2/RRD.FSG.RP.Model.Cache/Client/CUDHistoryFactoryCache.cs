...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class CUDHistoryFactoryCache:BaseFactoryCache<CUDHistoryFactory,CUDHistoryObjectModel,CUDHistoryKey>
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="CUDHistoryFactoryCache" /> class.
        /// </summary>
        /// <param name="dataAccess">Data access entity used to interface between the factory and the persisted storage.</param>
        public CUDHistoryFactoryCache(IDataAccess dataAccess)
            : base(new CUDHistoryFactory(dataAccess))
        {
        }
        ...
        public override string CollectionCacheKey
        {
            get
            {
                return string.Format("{0}:{1}", "CUDHistoryCacheKey",
                    (this.Factory.ConnectionString ?? string.Empty).GetHashCode());
            }
        }
        ...
        {
            get { return "RPV2HostedAdmin_CUDHistory_CacheDependencyCheck"; }
        }

...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class ClientDocumentFactoryCache
         : BaseFactoryCache<ClientDocumentFactory, ClientDocumentObjectModel, int>
    {
        ...
        public ClientDocumentFactoryCache(IDataAccess dataAccess)
            : base(new ClientDocumentFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "ClientDocumentFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_ClientDocumentData_CacheDependencyCheck"; }
        }

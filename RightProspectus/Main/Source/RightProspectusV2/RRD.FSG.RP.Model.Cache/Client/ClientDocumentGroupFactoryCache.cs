...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class ClientDocumentGroupFactoryCache : BaseFactoryCache<ClientDocumentGroupFactory, ClientDocumentGroupObjectModel, int>
    {
        
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="ClientDocumentGroupFactoryCache" /> class.
        /// </summary>
        /// <param name="dataAccess">Data access entity used to interface between the factory and the persisted storage.</param>
        public ClientDocumentGroupFactoryCache(IDataAccess dataAccess)
            : base(new ClientDocumentGroupFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "ClientDocumentGroupFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_ClientDocumentGroup_CacheDependencyCheck"; }
        }

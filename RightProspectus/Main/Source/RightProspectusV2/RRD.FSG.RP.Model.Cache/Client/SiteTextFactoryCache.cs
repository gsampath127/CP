...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class SiteTextFactoryCache
        : BaseFactoryCache<SiteTextFactory, SiteTextObjectModel,SiteTextKey>
    {
        #region Constructors
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SiteTextFactoryCache" /> class.
        /// </summary>
        /// <param name="dataAccess">Data access entity used to interface between the factory and the persisted storage.</param>
        public SiteTextFactoryCache(IDataAccess dataAccess)
            : base(new SiteTextFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "SiteTextFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_SiteTextData_CacheDependencyCheck"; }
        }

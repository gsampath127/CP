...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
    public class TemplatePageNavigationFactoryCache : BaseFactoryCache<TemplatePageNavigationFactory, TemplatePageNavigationObjectModel, TemplatePageNavigationKey>
    {
        #region Constructors
        ...
        public TemplatePageNavigationFactoryCache(IDataAccess dataAccess)
            : base(new TemplatePageNavigationFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "TemplatePageNavigationFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_StaticTemplatePageNavigation_CacheDependencyCheck"; }
        }

...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
    public class TemplatePageFeatureFactoryCache
         : BaseFactoryCache<TemplatePageFeatureFactory, TemplatePageFeatureObjectModel, TemplatePageFeatureKey>
    {
        ...
        public TemplatePageFeatureFactoryCache(IDataAccess dataAccess)
            : base(new TemplatePageFeatureFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "TemplatePageFeatureFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_StaticTemplatePageFeature_CacheDependencyCheck"; }
        }

...
BEGIN
	...
	SELECT DISTINCT MarketID FROM DocumentTypeAssociation
...
PRINT N'Creating [dbo].[RPV2HostedAdmin_BrowserVersionData_CacheDependencyCheck]...';
GO
...
PRINT N'Creating [dbo].[RPV2HostedAdmin_DeleteBrowserVersion]...';
GO
...
PRINT N'Creating [dbo].[RPV2HostedAdmin_GetAllBrowserVersion]...';
GO
...
PRINT N'Creating [dbo].[RPV2HostedAdmin_SaveBrowserVersion]...';
GO
...
END;
GO
PRINT N'Creating [dbo].[T_BrowserVersion_D]...';
...
END;
GO
PRINT N'Creating [dbo].[T_BrowserVersion_I]...';
...
END;
GO
PRINT N'Creating [dbo].[T_BrowserVersion_U]...';

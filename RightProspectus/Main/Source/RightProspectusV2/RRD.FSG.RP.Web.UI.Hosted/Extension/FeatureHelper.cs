...
namespace RRD.FSG.RP.Web.UI.Hosted
{
    ...
    public static class FeatureHelper
    {
        ...
        public static List<FeatureEnums.FundOrder> GetFeatureModesFundOrder(int mode)
        {
            FeatureEnums.FundOrder featureMode = (FeatureEnums.FundOrder)mode;
            List<FeatureEnums.FundOrder> featureModes = new List<FeatureEnums.FundOrder>();

            if (featureMode.HasFlag(FeatureEnums.FundOrder.AlphabeticalAsc))
            {
                featureModes.Add(FeatureEnums.FundOrder.AlphabeticalAsc);
            }
            if (featureMode.HasFlag(FeatureEnums.FundOrder.AlphabeticalDesc))
            {
                featureModes.Add(FeatureEnums.FundOrder.AlphabeticalDesc);
            }
            if (featureMode.HasFlag(FeatureEnums.FundOrder.CustomizeOrder))
            {
                featureModes.Add(FeatureEnums.FundOrder.CustomizeOrder);
            }
        ...
        public static List<FeatureEnums.FundNameFormat> GetFeatureModesFundNameFormat(int mode)
        {
            FeatureEnums.FundNameFormat featureMode = (FeatureEnums.FundNameFormat)mode;
            List<FeatureEnums.FundNameFormat> featureModes = new List<FeatureEnums.FundNameFormat>();

            if (featureMode.HasFlag(FeatureEnums.FundNameFormat.RPFundName))
            {
                featureModes.Add(FeatureEnums.FundNameFormat.RPFundName);
            }
            if (featureMode.HasFlag(FeatureEnums.FundNameFormat.CompanyName))
            {
                featureModes.Add(FeatureEnums.FundNameFormat.CompanyName);
            }

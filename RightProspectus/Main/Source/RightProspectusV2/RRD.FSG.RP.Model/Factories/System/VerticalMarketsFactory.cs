...
{
    /// <summary>
    /// Class VerticalMarketsFactory.
    /// </summary>
    public class VerticalMarketsFactory : AuditedBaseFactory<VerticalMarketsObjectModel, int>
    {
        #region Constants
        /// <summary>
        /// The sp get all Template Page
        /// </summary>
        private const string SPGetAllVerticalMarkets = "RPV2HostedAdmin_GetAllVerticalMarkets";
        ...
        /// MarketName
        /// </summary>
        private const string DBCMarketName = "MarketName";

        /// <summary>
        /// MarketDescription
        /// </summary>
        private const string DBCMarketDescription = "MarketDescription";
       

        #endregion

        /// <summary>
        /// Initializes a new instance of the <see cref="VerticalMarketsFactory" /> class.
        /// </summary>
        /// <param name="dataAccess">Data access entity used to interface between the factory and the persisted storage.</param>
        public VerticalMarketsFactory(IDataAccess dataAccess)
            : base(dataAccess) {
        ...
        public override TEntity CreateEntity<TEntity>(DataRow entityRow)
        {
            ...
            if (entity != null)
            {
                ...
                entity.VerticalMarketId = entityRow.Field<int>(DBCVerticalMarketID);
                entity.Key = entity.VerticalMarketId;
                entity.MarketName = entityRow.Field<string>(DBCMarketName);
                entity.MarketDescription = entityRow.Field<string>(DBCMarketDescription);
        ...
        {
            return this.GetEntitiesInternal<TEntity>(SPGetAllVerticalMarkets, startRowIndex, maximumRows,null);
        }
        ...
        {
            return this.GetEntitiesInternal<TEntity>(SPGetAllVerticalMarkets, startRowIndex, maximumRows,sort);
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void SaveEntity(VerticalMarketsObjectModel entity)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void SaveEntity(VerticalMarketsObjectModel entity, int modifiedBy)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(VerticalMarketsObjectModel entity)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(VerticalMarketsObjectModel entity, int deletedBy)
        {
            throw new NotImplementedException();
        }

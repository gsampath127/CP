...
namespace RRD.FSG.RP.Model.Factories.System
{
    ...
    /// </summary>
    public class TemplateTextFactory : BaseFactory<TemplateTextObjectModel, TemplateTextKey>
    {
        #region Constants
        /// <summary>
        /// The sp get all Template Page
        /// </summary>
        private const string SPGetAllTemplateText = "RPV2HostedAdmin_GetAllTemplateText";
        ...
        public TemplateTextFactory(IDataAccess dataAccess)
            : base(dataAccess) {
        ...
        public override TEntity GetEntityByKey<TEntity>(TemplateTextKey key)
        {
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void SaveEntity(TemplateTextObjectModel entity)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(TemplateTextKey key)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void SaveEntity(TemplateTextObjectModel entity, int modifiedBy)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="modifiedBy">The modified by.</param>
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(TemplateTextKey key, int modifiedBy)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(TemplateTextObjectModel entity)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(TemplateTextObjectModel entity, int deletedBy)
        {
            throw new NotImplementedException();
        }
        ...
        {
            return this.GetEntitiesInternal<TEntity>(SPGetAllTemplateText, startRowIndex, maximumRows, sort);
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override IEnumerable<TEntity> GetEntitiesBySearch<TEntity>(int startRowIndex, int maximumRows, ISearchDetail<TEntity> search, ISortDetail<TEntity> sort, out int totalRecordCount, params TemplateTextKey[] entitiesToIgnore)
        {
            throw new NotImplementedException();
        }
    }

...
namespace RRD.FSG.RP.Model.Factories.HostedPages
{
    ...
    public class HostedClientPageScenariosFactory : HostedPageBaseFactory, IHostedClientPageScenariosFactory
    {
        ...
        /// The sp get billing report data
        /// </summary>
        private const string SPGetDocumentUpdateTaxonomyData = "RPV2HostedSites_GetDocumentUpdateTaxonomyData";
        ...
        /// <summary>
        /// The sp GetClientDocumentByClientDocumentId
        /// </summary>
        private const string SPGetClientDocumentByClientDocumentId = "RPV2HostedSites_GetClientDocumentByClientDocumentId";
        /// <summary>
        ...
        /// <summary>
        /// The sp GetTaxonomyAssociationClientDocumentFrame
        /// </summary>
        private const string SPGetTaxonomyAssociationClientDocumentFrame = "RPV2HostedSites_GetTaxonomyAssociationClientDocumentFrame";

        /// <summary>
        /// The sp GetTaxonomyAssociationGroups
        /// </summary>
        private const string SPGetTaxonomyAssociationGroups = "RPV2HostedSites_GetTaxonomyAssociationGroups";

        /// <summary>
        /// The sp GetBrowserVersion
        /// </summary>
        private const string SPGetBrowserVersion = "RPV2HostedSites_GetBrowserVersion";

        /// <summary>
        /// The table type TT_DocumentUpdateVerticalData
        /// </summary>
        private const string DBCDocumentUpdateVerticalData = "TT_DocumentUpdateVerticalData";

        /// <summary>
        /// ClientDocumentType
        /// </summary>
        private const string DBCClientDocumentType = "ClientDocumentType";
        /// <summary>
        ...
        /// The dbctagid
        /// </summary>
        private const string DBCTAGID = "TAGID";
        ...
        /// <summary>
        /// The DBC browser name
        /// </summary>
        private const string DBCBrowserName = "BrowserName";
        /// <summary>
        ...
        private List<TaxonomyAssociationLinkModel> GetTaxonomyAssociationLinksClientData(string clientName,
                                                                                string siteName, bool isProofing,
                                                                                 DataTable verticalIds)
        {
            ...
            DataTable results = DataAccess.ExecuteDataTable(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         ...
                         DataAccess.CreateParameter(DBCIsProofing, DbType.Boolean, isProofing)
                         );
            ...
            foreach (DataRow datarow in results.Rows)
            {
                ...
                taxonomyassociationlink.FundOrder = datarow.Field<int>("FundOrder");
        ...
        private TaxonomyAssociationHierarchyModel GetTaxonomyAssociationHierarchyDocumentsClientData(string clientName, string siteName, bool isProofing,
                                        string externalID, int? internalPTAID, DataTable verticalIds)
        {
            ...
            DataTable results = DataAccess.ExecuteDataTable(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         ...
                         !string.IsNullOrWhiteSpace(externalID) ? DataAccess.CreateParameter(DBCExternalID, DbType.String, externalID) :
                          ...
                          DataAccess.CreateParameter(DBCSiteName, DbType.String, siteName),
                          DataAccess.CreateParameter(DBCIsProofing, DbType.String, isProofing)
                         );
            ...
            foreach (DataRow datarow in results.Rows)
            {
                ...
                if (previousTaxonomyID != taxonomyID)
                {
                    ...
                    taxonomyAssociationDocumentModel.FundOrder = datarow.Field<int>("FundOrder");
        ...
        private TaxonomyAssociationDocumentsModel GetTaxonomyAssociationDocumentsClientData(string clientName,
                                                                                 string siteName, bool isProofing, DataTable verticalIds)
        {
            ...
            foreach (DataRow datarow in results.Rows)
            {
                ...
                if (previousTaxonomyID != taxonomyID)
                {
                    ...
                    taxonomyAssociationData.FundOrder = datarow.Field<int>("FundOrder");
        ...
        private TaxonomyAssociationData GetTaxonomySpecificDocumentsClientData(string clientName, string siteName, bool isProofing, string externalID, int? internalTAID, DataTable verticalIds)
        {
            int previousTaxonomyID = -1;
        ...
        /// <returns>List&lt;TaxonomyAssociationLinkModel&gt;.</returns>
        public List<TaxonomyAssociationLinkModel> GetTaxonomyAssociationLinks(string clientName, string site, bool isProofing, FeatureEnums.FundOrder taxonomyOrderFeatureMode, FeatureEnums.FundNameFormat fundNameFormatFeature)
        {
            ...
            List<TaxonomyAssociationLinkModel> taxonomyassociationlinks = GetTaxonomyAssociationLinksClientData(clientName,
                                                                                    site, isProofing, clientTaxonomyIDs);

            if (taxonomyassociationlinks.Count > 0)
            {
                return iHostedVerticalPageScenarios.GetTaxonomyAssociationLinksVerticalData(clientTaxonomyIDs, clientName, taxonomyassociationlinks, taxonomyOrderFeatureMode, fundNameFormatFeature);
            }
            else
            {
                return null;
        ...
        public BillingReportModel GetTaxonomyAssociationforBillingreport(string clientName, DateTime startDate, DateTime endDate)
        {
            ...
            billingData.DocumentTypeMaketIds = new List<string>();
            ...
            foreach (DataRow datarow in results.Tables[4].Rows)
            {
                switch (datarow.Field<string>("MarketID"))
                {
                    case"XBRL":
                        billingData.IsXBRLEnabled = true;
                        break;
                    case "PVR":
                        billingData.IsPVREnabled = true;
                        break;
                    case "FS":
                        billingData.IsFSEnabled = true;
                        break;
                    default:
                        break;
                }                
            ...
            {               
                ...
                List<BillingReportActiveFundDetails> lstActive = iHostedVerticalPageScenarios.GetBillingReportVerticalData(clientTaxonomyIDs, clientName, lstActiveFunds, startDate, endDate);
                ...
                billingData.SummaryProspectusCount = lstActive.FindAll(t => t.IsSummaryProspectus == "Y").Count;
                billingData.ProspectusCount = lstActive.FindAll(t => t.IsProspectus == "Y").Count;
                billingData.SAICount = lstActive.FindAll(t => t.IsSAI == "Y").Count;
                billingData.AnnualReportCount = lstActive.FindAll(t => t.IsAnnualReport == "Y").Count;
                billingData.SemiAnnualReportCount = lstActive.FindAll(t => t.IsSemiAnnualReport == "Y").Count;

                billingData.NewFundCount = Convert.ToInt32(results.Tables[1].Rows[0][0].ToString());

                billingData.UniqueSeriesIdCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.SeriesID)).Select(x => x.SeriesID).Distinct().Count();
                billingData.UniqueCUSIPcount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.MarketID)).Select(x => x.MarketID).Distinct().Count();
                billingData.UniqueSummaryProspectusPdfNamesCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.SPPDFName) && x.SPPDFName != "NA").Select(x => x.SPPDFName).Distinct().Count();
                billingData.UniqueProspectusPdfNamesCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.PPDFName) && x.PPDFName != "NA").Select(x => x.PPDFName).Distinct().Count();
                billingData.UniqueSAIPdfNamesCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.SAIPDFName) && x.SAIPDFName != "NA").Select(x => x.SAIPDFName).Distinct().Count();
                billingData.UniqueSemiAnnualReportPdfNamesCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.SARPDFName) && x.SARPDFName != "NA").Select(x => x.SARPDFName).Distinct().Count();
                billingData.UniqueAnnualReportPdfNamesCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.ARPDFName) && x.ARPDFName != "NA").Select(x => x.ARPDFName).Distinct().Count();
                billingData.UniquePVRPdfNamesCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.PVRPDFName) && x.PVRPDFName != "NA").Select(x => x.PVRPDFName).Distinct().Count();
                billingData.UniqueFSPdfNamesCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.FactSheetPDFName) && x.FactSheetPDFName != "NA").Select(x => x.FactSheetPDFName).Distinct().Count();


                billingData.SPDocumentUpdatedCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.SPDocumentUpdatedDate) && x.SPDocumentUpdatedDate != "N").Select(x => x.SPPDFName).Distinct().Count();
                billingData.PDocumentUpdatedCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.PDocumentUpdatedDate) && x.PDocumentUpdatedDate != "N").Select(x => x.PPDFName).Distinct().Count();
                billingData.SAIDocumentUpdatedCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.SAIDocumentUpdatedDate) && x.SAIDocumentUpdatedDate != "N").Select(x => x.SAIPDFName).Distinct().Count();
                billingData.ARDocumentUpdatedCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.ARDocumentUpdatedDate) && x.ARDocumentUpdatedDate != "N").Select(x => x.ARPDFName).Distinct().Count();
                billingData.SARDocumentUpdatedCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.SARDocumentUpdatedDate) && x.SARDocumentUpdatedDate != "N").Select(x => x.SARPDFName).Distinct().Count();
                billingData.FSDocumentUpdatedCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.FSDocumentUpdatedDate) && x.FSDocumentUpdatedDate != "N").Select(x => x.FactSheetPDFName).Distinct().Count();
                billingData.PVRDocumentUpdatedCount = lstActive.Where(x => !string.IsNullOrWhiteSpace(x.PVRDocumentUpdatedDate) && x.PVRDocumentUpdatedDate != "N").Select(x => x.PVRPDFName).Distinct().Count();
                                

                foreach (var item in billingData.LstBillingReportActiveFundDetails)
                {
                    ...
                    if (string.IsNullOrWhiteSpace(item.FundName))
                    {
                        item.FundName = "NA";
                    }
                    ...
                    if (string.IsNullOrWhiteSpace(item.SECFundName))
                    {
                        item.SECFundName = "NA";
                    }                    
                }
        ...
        /// <param name="endDate"></param>
        /// <returns></returns>
        public List<DocumentUpdateReportModel> GetTaxonomyAssociationforDocumentUpdateReport(string clientName, DateTime startDate, DateTime endDate)
        {
            //Step 1: Check IF SAR validation is enabled.
            ClientSiteData clientSiteData = GetClientsSiteData(clientName);
            int defaultSiteID = clientSiteData.Sites.Find(s => s.IsDefaultSite).SiteId;
            int sarValidationFeatureMode = 0;

            HostedSiteFeature hostedSiteFeature = clientSiteData.SiteFeatures.Find(x => x.SiteID == defaultSiteID && x.FeatureKey == "SARValidation");
            if (hostedSiteFeature != null)
            {
                sarValidationFeatureMode = hostedSiteFeature.FeatureMode;
            }
            FeatureEnums.SARValidation featureMode = (FeatureEnums.SARValidation)sarValidationFeatureMode;

            bool isSARValidationEnabled = featureMode.HasFlag(FeatureEnums.SARValidation.Enabled);


            //Step 2: GET all taxonomy ids from client DBs
            DataTable clientTaxonomyIDs = new DataTable();
            ...
            DataSet results = DataAccess.ExecuteDataSet(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         SPGetDocumentUpdateTaxonomyData
                         );

            foreach (DataRow datarow in results.Tables[0].Rows)
            {
                clientTaxonomyIDs.Rows.Add(datarow.Field<string>("MarketId"), datarow.Field<bool>("IsNameOverrideProvided"));
            }

            //Step 3: Verify data with verticalDB and get updated document dates and updated dates

            DataTable docUpDtReportVerticalData = iHostedVerticalPageScenarios.GetDocumentUpdateReportVerticalData(startDate, endDate, clientTaxonomyIDs, clientName);


            //Step 4: Pass docUpDtReportVerticalData to client db and get final data

            results = DataAccess.ExecuteDataSet(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         SPGetDocumentUpdateReportData,
                         DataAccess.CreateParameter(DBCDocumentUpdateVerticalData, SqlDbType.Structured, docUpDtReportVerticalData),
                         DataAccess.CreateParameter(DCBStartDate, DbType.DateTime, startDate),
                         DataAccess.CreateParameter(DCBEndDate, DbType.DateTime, endDate)
                         );

            string previousMarketId = string.Empty;
            DateTime ARDocumentDate = DateTime.MinValue;
            ...
            foreach (DataRow datarow in results.Tables[0].Rows)
            {
                ...
                {
                    ARDocumentDate = DateTime.MinValue;
                    previousMarketId = marketId;
                }

                string documentTypeMarketId = datarow.Field<string>("DocumentTypeMarketId");
                DateTime? documentDate = datarow.Field<DateTime?>("DocumentDate");
                if (documentTypeMarketId == "AR")
                {
                    ARDocumentDate = documentDate.HasValue ? documentDate.Value : DateTime.MinValue;
                }

                if (documentTypeMarketId != "SAR" || !documentDate.HasValue || !(ARDocumentDate > documentDate.Value && isSARValidationEnabled))
                {
                    lstDocumentUpdateReportModel.Add(new DocumentUpdateReportModel
                    {
                        MarketID = marketId,
                        DocumentTypeMarketId = documentTypeMarketId,
                        DocumentUpdatedDate = datarow.Field<DateTime?>("DocumentUpdatedDate"),
                        DocumentDate = documentDate,
                        IsDocUpdated = datarow.Field<string>("DocumentUpdated")
                    });
                }
            }

            return lstDocumentUpdateReportModel;
        }
        ...
        /// <param name="taxonomyOrderFeatureMode">taxonomyOrderFeatureMode.</param>
        /// <returns>TaxonomyAssociationHierarchyModel.</returns>
        public TaxonomyAssociationHierarchyModel GetTaxonomyAssociationHierarchyDocuments(string clientName, string site, bool isProofing,
                                            string externalID, int? internalPTAID, FeatureEnums.FundOrder taxonomyOrderfeature, FeatureEnums.FundNameFormat fundNameFormatFeature)
        {
            ...
            if (taxonomyAssociationHierarchyModel.ParentTaxonomyAssociationData.Count > 0)
            {
                return iHostedVerticalPageScenarios.GetTaxonomyAssociationHierarchyDocumentsVerticalData(clientTaxonomyIDsWithDocTypeIDs, clientName,
                                                                                                            taxonomyAssociationHierarchyModel, taxonomyOrderfeature, fundNameFormatFeature);
            }
            else
            {
                return null;
        ...
        /// <param name="taxonomyOrderFeatureMode">taxonomyOrderFeatureMode</param>
        /// <returns>TaxonomyAssociationDocumentsModel.</returns>
        public TaxonomyAssociationDocumentsModel GetTaxonomyAssociationDocuments(string clientName, string siteName, bool isProofing, FeatureEnums.FundOrder taxonomyOrderFeatureMode)
        {
            DataTable clientTaxonomyIDsWithDocTypeIDs = new DataTable();
            ...
            if (taxonomyAssociationDocumentsModel.TaxonomyAssociationDocumentsData.Count > 0)
            {
                return iHostedVerticalPageScenarios.GetTaxonomyAssociationDocumentsVerticalData(clientTaxonomyIDsWithDocTypeIDs, clientName,
                                                                                                            taxonomyAssociationDocumentsModel, taxonomyOrderFeatureMode);
            }
            else
            {
                return null;
        ...
        /// <param name="internalTAID">The internal taid.</param>
        /// <returns>TaxonomyAssociationData.</returns>
        public TaxonomyAssociationData GetTaxonomySpecificDocuments(string clientName, string siteName,  bool isProofing, string externalID,
                                                                    int? internalTAID, FeatureEnums.FundNameFormat fundNameFormatFeature)
        {
            DataTable clientTaxonomyIDsWithDocTypeIDs = new DataTable();
            ...
            TaxonomyAssociationData taxonomyAssociationData = GetTaxonomySpecificDocumentsClientData(
                                                                         clientName, siteName, isProofing,
            ...
            if (taxonomyAssociationData != null && taxonomyAssociationData.DocumentTypes != null && taxonomyAssociationData.DocumentTypes.Count > 0)
            {
                taxonomyAssociationData = iHostedVerticalPageScenarios.GetTaxonomySpecificDocumentsVerticalData(clientTaxonomyIDsWithDocTypeIDs, clientName,
                                                                                                            taxonomyAssociationData, fundNameFormatFeature);
            }
        ...
        public List<XBRLObjectModel> GetXBRLByTaxonomyAssociationIDOrExternalID(string clientName, bool isProofing, int? taxonomyAssociationId, string externalId, bool pid)
        {
        ...
        public ClientDocumentObjectModel GetClientDocumentDetails(string clientName, int clientDocumentId)
        {
            ClientDocumentObjectModel clientDocumentObjectModel = null;
            DataSet results = DataAccess.ExecuteDataSet(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         SPGetClientDocumentByClientDocumentId,
                         DataAccess.CreateParameter(DBCClientDocumentId, DbType.Int32, clientDocumentId)
                         );
            ...
            if (results != null && results.Tables.Count > 0)
            {
                ...
                {
                    DataRow datarow = results.Tables[0].Rows[0];
                    clientDocumentObjectModel = new ClientDocumentObjectModel();
                    clientDocumentObjectModel.FileName = datarow.Field<string>("FileName");
                    clientDocumentObjectModel.MimeType = datarow.Field<string>("MimeType");
                    clientDocumentObjectModel.FileData = datarow.Field<byte[]>("Data");
                    clientDocumentObjectModel.LastModified = datarow.Field<DateTime>("UtcModifiedDate");
                }
            }

            return clientDocumentObjectModel;
        }
        ...
        /// <param name="verticalIds">The vertical ids.</param>
        /// <returns>TaxonomyAssociationData.</returns>
        public TaxonomyAssociationData GetTaxonomyAssociationClientDocuments(string clientName, bool isProofing, string externalID1, string externalID2,
                                                                    int? internalTAID)
        {
            DataTable clientTaxonomyIDs = new DataTable();
            ...
            TaxonomyAssociationData taxonomyAssociationData = GetTaxonomyAssociationClientDocumentsDetails(
                                                                         clientName, isProofing,
                                                                        externalID1, externalID2, internalTAID,
                                                                        clientTaxonomyIDs);

            if (taxonomyAssociationData != null && taxonomyAssociationData.ClientDocuments != null && taxonomyAssociationData.ClientDocuments.Count > 0)
            {
                taxonomyAssociationData = iHostedVerticalPageScenarios.GetTaxonomyAssociationClientDocumentsVerticalData(clientTaxonomyIDs, clientName,
        ...
        /// <summary>
        /// GetTaxonomyAssociationClientDocumentsDetails
        /// </summary>
        /// <param name="clientName">Name of the client.</param>
        /// <param name="externalID1">MARKET ID</param>
        /// <param name="externalID2">Client Document type name.</param>
        ...
        /// <param name="verticalIds">The vertical ids.</param>
        /// <returns>TaxonomyAssociationData.</returns>
        private TaxonomyAssociationData GetTaxonomyAssociationClientDocumentsDetails(string clientName, bool isProofing, string externalID1, string externalID2, int? internalTAID, DataTable verticalIds)
        {
            TaxonomyAssociationData taxonomyAssociationData = null;

            DataTable results = DataAccess.ExecuteDataTable(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         SPGetTaxonomyAssociationClientDocumentFrame,
                         !string.IsNullOrWhiteSpace(externalID1) ? DataAccess.CreateParameter("ExternalId", DbType.String, externalID1) :
                                                                  DataAccess.CreateParameter("TAID", DbType.Int32, internalTAID),
                         DataAccess.CreateParameter(DBCClientDocumentType, DbType.String, externalID2),
                         DataAccess.CreateParameter(DBCIsProofing, DbType.Boolean, isProofing)
                         );
            ...
            foreach (DataRow datarow in results.Rows)
            {
                ...
                if (taxonomyAssociationData == null)
                {
                    taxonomyAssociationData = new TaxonomyAssociationData();
                    taxonomyAssociationData.ClientDocuments = new List<ClientDocumentObjectModel>();

                    string taxonomyName = datarow.Field<string>("TaxonomyNameOverRide");

                    taxonomyAssociationData.TaxonomyID = datarow.Field<int>("TaxonomyID");
                    ...
                    taxonomyAssociationData.MarketId = datarow.Field<string>("MarketId");

                    verticalIds.Rows.Add(taxonomyAssociationData.MarketId,
                                        !string.IsNullOrWhiteSpace(taxonomyName));
                }

                taxonomyAssociationData.ClientDocuments.Add(new ClientDocumentObjectModel
                {
                    ClientDocumentId = datarow.Field<int>("ClientDocumentId"),
        ...
        public TaxonomyAssociationGroupModel GetTaxonomyAssociationGroupDocuments(string clientName, string site, bool isProofing, 
                                                                                int? groupId, FeatureEnums.FundOrder taxonomyOrderFeatureMode)
        {
            return GetTaxonomyAssociationGroupDocumentsClientData(clientName, site, isProofing, groupId, taxonomyOrderFeatureMode);
        }

        private TaxonomyAssociationGroupModel GetTaxonomyAssociationGroupDocumentsClientData(string clientName, string siteName, bool isProofing,
                                                                            int? groupId, FeatureEnums.FundOrder taxonomyOrderFeatureMode)
        {
            DataTable clientTaxonomyIDsWithDocTypeIDs = new DataTable();
            ...
            TaxonomyAssociationGroupModel taxonomyAssociationGroupModel = new TaxonomyAssociationGroupModel();
            taxonomyAssociationGroupModel.TAGDetails = new List<object>();
            taxonomyAssociationGroupModel.FootNotes = new List<HostedSiteFootNotes>();
            taxonomyAssociationGroupModel.DocumentTypeHeaders = new List<HostedDocumentTypeHeader>();
            taxonomyAssociationGroupModel.TAGTAData = new List<TaxonomyAssociationGroupTaxonomyAssociationData>();
            
            DataSet results = DataAccess.ExecuteDataSet(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         SPGetTaxonomyAssociationGroups,
                          DataAccess.CreateParameter(DBCSiteName, DbType.String, siteName),
                          DataAccess.CreateParameter(DBCIsProofing, DbType.Boolean, isProofing)
                         );

            //foreach (DataRow group in results.Tables[0].Rows)
            //{
            //    taxonomyAssociationGroupModel.TAGDetails.Add(new
            //    {
            //        Id = group.Field<int>("TaxonomyAssociationGroupId"),
            //        Name = group.Field<string>("Name")
            //    });
            //}
            int previousGroupLevel = -1;
            int previousTaxonomyAssociationGroupId = -1;            
            int previousTaxonomyAssociationId = -1;
            TaxonomyAssociationData taxonomyAssociationData = null;
            TaxonomyAssociationGroupTaxonomyAssociationData ValidateTAGTADataModel = new TaxonomyAssociationGroupTaxonomyAssociationData();
            bool taxonomyNameOverride = false;

            foreach (DataRow datarow in results.Tables[0].Rows)
            {
                int groupLevel = datarow.Field<int>("GroupLevel");             

                int taxonomyAssociationGroupId = datarow.Field<int>("TaxonomyAssociationGroupId");

                if (previousTaxonomyAssociationGroupId != taxonomyAssociationGroupId)
                {
                    ValidateTAGTADataModel = new TaxonomyAssociationGroupTaxonomyAssociationData();
                    taxonomyAssociationGroupModel.TAGTAData.Add(ValidateTAGTADataModel);
                    
                    ValidateTAGTADataModel.TaxonomyAssociationData = new List<TaxonomyAssociationData>();
                    ValidateTAGTADataModel.TaxonomyAssociationGroupId = taxonomyAssociationGroupId;
                    ValidateTAGTADataModel.ParentTaxonomyAssociationGroupId = datarow.Field<int?>("ParentTaxonomyAssociationGroupId");
                    ValidateTAGTADataModel.Name = datarow.Field<string>("Name");
                    ValidateTAGTADataModel.GroupOrder = datarow.Field<int?>("GroupOrder");
                    ValidateTAGTADataModel.GroupLevel = groupLevel;

                    previousTaxonomyAssociationId = -1;
                    taxonomyAssociationData = null;

                    previousTaxonomyAssociationGroupId = taxonomyAssociationGroupId;
                }

                

                if (datarow.Field<int?>("TaxonomyAssociationId") != null)
                {
                    int taxonomyAssociationId = datarow.Field<int>("TaxonomyAssociationId");
                    int taxonomyID = datarow.Field<int>("TaxonomyID");
                    if (previousTaxonomyAssociationId != taxonomyAssociationId)
                    {
                        taxonomyAssociationData = new TaxonomyAssociationData();
                        ValidateTAGTADataModel.TaxonomyAssociationData.Add(taxonomyAssociationData);

                        string FootNote = datarow.Field<string>("FootnoteText");
                        string taxonomyName = datarow.Field<string>("NameOverride");
                        if (!string.IsNullOrWhiteSpace(FootNote))
                        {
                            if (!taxonomyAssociationGroupModel.FootNotes.Exists(f => f.Text == FootNote))
                            {
                                taxonomyAssociationGroupModel.FootNotes.Add(new HostedSiteFootNotes()
                                {
                                    Text = FootNote,
                                    Order = datarow.Field<int>("FootnoteOrder"),
                                    TaxonomyID = taxonomyID,
                        ...
                        previousTaxonomyAssociationId = taxonomyAssociationId;
                    ...
                    List<HostedDocumentTypeHeader> currentheader = taxonomyAssociationGroupModel.DocumentTypeHeaders;
                    if (!currentheader.Exists(f => f.HeaderName == documentTypeHeaderText))
                    {
                        currentheader.Add(new HostedDocumentTypeHeader()
                        {
                            HeaderName = documentTypeHeaderText,
                    ...
                    if (clientTaxonomyIDsWithDocTypeIDs.Select("TaxonomyID = " + taxonomyID + " AND DocumentTypeId = " + documentTypeId).Length == 0)
                    {
                        clientTaxonomyIDsWithDocTypeIDs.Rows.Add(taxonomyID,
                                            taxonomyNameOverride,
                                            documentTypeId,
                                            !string.IsNullOrWhiteSpace(documentTypeLinkText),
                                            false);
            ...
            taxonomyAssociationGroupModel = iHostedVerticalPageScenarios.GetTaxonomyAssociationGroupDocumentsVerticalData(clientTaxonomyIDsWithDocTypeIDs, clientName,
                                                                                                            taxonomyAssociationGroupModel, taxonomyOrderFeatureMode);         

            previousGroupLevel = -1;
            previousTaxonomyAssociationGroupId = -1;

            List<TaxonomyAssociationGroupTaxonomyAssociationData> ParentTAGTADataList = new List<TaxonomyAssociationGroupTaxonomyAssociationData>();
            List<TaxonomyAssociationGroupTaxonomyAssociationData> ChildTAGTADataList = new List<TaxonomyAssociationGroupTaxonomyAssociationData>();

            foreach (var item in taxonomyAssociationGroupModel.TAGTAData.OrderByDescending(p=>p.GroupLevel))
            {
                if (previousGroupLevel != item.GroupLevel)
                {
                    switch (taxonomyOrderFeatureMode.ToString())
                    {
                        case "AlphabeticalAsc":
                            ParentTAGTADataList.Sort((x, y) => x.Name.CompareTo(y.Name));
                            break;
                        case "AlphabeticalDesc":
                            ParentTAGTADataList.Sort((x, y) => -1 * x.Name.CompareTo(y.Name));
                            break;
                        case "CustomizeOrder":
                            ParentTAGTADataList.Sort((x, y) => x.GroupOrder.Value.CompareTo(y.GroupOrder.Value));
                            break;
                        default:
                            ParentTAGTADataList.Sort((x, y) => x.Name.CompareTo(y.Name));
                            break;
                    ...
                    ChildTAGTADataList = ParentTAGTADataList;
                    ParentTAGTADataList = new List<TaxonomyAssociationGroupTaxonomyAssociationData>();

                    previousGroupLevel = item.GroupLevel;
                }                
                
                item.ChildTAGTAData = ChildTAGTADataList.FindAll(p => p.ParentTaxonomyAssociationGroupId.Value == item.TaxonomyAssociationGroupId);                    
                ParentTAGTADataList.Add(item);
            }
            ...
            taxonomyAssociationGroupModel.TAGTAData = ParentTAGTADataList;
            return taxonomyAssociationGroupModel;
        }

        public BrowserVersionObjectModel GetBrowserVersion(string clientName, string siteName, string browserName)
        {
            BrowserVersionObjectModel browserVersionObjectModel = null;
            DataTable result = DataAccess.ExecuteDataTable(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         SPGetBrowserVersion,
                         DataAccess.CreateParameter(DBCBrowserName, DbType.String, browserName)
                         );
            if (result.Rows.Count > 0)
            {
                browserVersionObjectModel = new BrowserVersionObjectModel();
                DataRow datarow = result.Rows[0];
                browserVersionObjectModel.Id = datarow.Field<int>("Id");
                browserVersionObjectModel.Name = datarow.Field<string>("Name");
                browserVersionObjectModel.MinimumVersion = datarow.Field<int>("Version");
                browserVersionObjectModel.DownloadUrl = datarow.Field<string>("DownloadUrl");
                browserVersionObjectModel.LogoStaticResourceURL = string.Format("{0}staticresource/{1}?client={2}", ConfigurationManager.AppSettings.Get(HostedEngineURL), browserName, clientName);
            }

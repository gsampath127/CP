...
namespace RRD.FSG.RP.Model.SearchEntities.System
{
        ...
        : AuditedSearchDetail<ClientObjectModel>, ISearchDetailCopyAs<ClientSearchDetail>
    {
        ...
        /// <summary>
        /// IsClientDocumentsAvailableFromFTPCompare
        /// </summary>
        /// <value><c>null</c> if [is enabled] contains no value, <c>true</c> if [is enabled]; otherwise, <c>false</c>.</value>
        public bool? IsClientDocumentsAvailableFromFTP { get; set; }

        /// <summary>
        /// Determines the type of comparison for the IsClientDocumentsAvailableFromFTPCompare property
        /// </summary>
        /// <value>The is enabled compare.</value>
        public ValueCompare IsClientDocumentsAvailableFromFTPCompare { get; set; }
        /// <summary>
        ...
        public override Func<ClientObjectModel, bool> SearchPredicate
        {
            get
            {
                return entity =>
                    ...
                    && this.Match(this.IsClientDocumentsAvailableFromFTP, entity.IsClientDocumentsAvailableFromFTP, this.IsClientDocumentsAvailableFromFTPCompare);
            }
        }
            ...
            where TCopy : ClientSearchDetail, new()
        {
            ...
            copy.IsClientDocumentsAvailableFromFTP = this.IsClientDocumentsAvailableFromFTP;
            copy.IsClientDocumentsAvailableFromFTPCompare = this.IsClientDocumentsAvailableFromFTPCompare;

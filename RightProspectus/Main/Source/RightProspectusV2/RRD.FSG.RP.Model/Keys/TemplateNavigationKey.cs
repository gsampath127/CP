...
{
    /// <summary>
    /// Class TemplateNavigationKey.
    /// </summary>
    public class TemplateNavigationKey : IEquatable<TemplateNavigationKey>, IComparable<TemplateNavigationKey>, IComparable
    {
        /// <summary>
        ...
        public TemplateNavigationKey(int templateId, string navigationKey)
        {
        ...
        /// <summary>
        /// Gets the ResourceKey identifier of the entity.
        /// </summary>
        ...
        public bool Equals(TemplateNavigationKey other)
        {
        ...
        {
            return this.Equals(obj as TemplateNavigationKey);
        }
        ...
        /// <returns>Zero (0) if this instancae has the same TemplateId and NavigationKey.</returns>
        public int CompareTo(TemplateNavigationKey other)
        {
        ...
        public static TemplateNavigationKey Create(int templateId, string navigationKey)
        {
            return new TemplateNavigationKey(templateId, navigationKey);
        }
        ...
        public static bool operator >(TemplateNavigationKey key1, TemplateNavigationKey key2)
        {

...
{
    /// <summary>
    /// Class TemplateTextKey.
    /// </summary>
    public class TemplateTextKey : IEquatable<TemplateTextKey>, IComparable<TemplateTextKey>, IComparable
    {
        /// <summary>
        ...
        public TemplateTextKey(int templateId,  string resourceKey)
        {
        ...
        /// <returns>True if the TemplateId  and ResourceKey are the same.</returns>
        public bool Equals(TemplateTextKey other)
        {
        ...
        {
            return this.Equals(obj as TemplateTextKey);
        }
        ...
        public int CompareTo(TemplateTextKey other)
        {
        ...
        public static TemplateTextKey Create(int templateId, string resourceKey)
        {
            return new TemplateTextKey(templateId, resourceKey);
        }
        ...
        public static bool operator >(TemplateTextKey key1, TemplateTextKey key2)
        {

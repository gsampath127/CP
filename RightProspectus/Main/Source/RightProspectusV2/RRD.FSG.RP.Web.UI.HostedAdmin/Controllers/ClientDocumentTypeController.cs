...
namespace RRD.FSG.RP.Web.UI.HostedAdmin.Controllers
{
    ...
    public class ClientDocumentTypeController : BaseController
    {
        ...
        private const string HostedDocumentsDisplayCount = "HostedDocumentsDisplayCount";
        ...
        {   
            ...
            switch (kendoGridPost.SortColumn)
            {
                case Description:
                    ...
                    break;
                case HostedDocumentsDisplayCount:
                    SortColumn = ClientDocumentTypeSortColumn.HostedDocumentsDisplayCount;
                    break;
            ...
            return Json(new
            {
                ...
                data = (from objectModel in clientDocumentTypeCacheFactory.GetEntitiesBySearch(startRowIndex, kendoGridPost.PageSize,
                        ...
                        select new
                        {
                            ...
                            HostedDocumentsDisplayCount=objectModel.HostedDocumentsDisplayCount
                        })
            });
        }
        #endregion
        ...
        public ActionResult EditClientDocumentType(int id1)
        {
            ...
            {   
                ...
                objViewModel.FTPUsername = objObjectModel.FTPUsername;
                objViewModel.HostedDocumentsDisplayCount = objObjectModel.HostedDocumentsDisplayCount;
                objViewModel.FTPName = objObjectModel.FTPName;
                objViewModel.IsSFTP = objObjectModel.IsSFTP;
        ...
        public ActionResult EditClientDocumentType(ClientDocumentTypeViewModel objViewModel)
        {
            try
            {
                ClientDocumentTypeObjectModel objObjectModel = new ClientDocumentTypeObjectModel
                {
                    ...
                    FTPName=objViewModel.FTPName,
                    HostedDocumentsDisplayCount=objViewModel.HostedDocumentsDisplayCount,
                    FTPUsername=objViewModel.FTPUsername,
                    FTPPassword=objViewModel.FTPPassword,
                    IsSFTP=objViewModel.IsSFTP
                };

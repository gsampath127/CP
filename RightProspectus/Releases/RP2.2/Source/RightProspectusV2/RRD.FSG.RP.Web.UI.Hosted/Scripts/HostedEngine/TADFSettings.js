...
function ShowSubscriptionTab(subscriptionUrl) {
    $('#pnlFrameContainer').show();
    $('#idTADFDocumentNotAvailablePlaceHolderDiv').hide();
    
    $('#docFrame').attr('src', subscriptionUrl);
    ...
    $('.top').removeClass("cssMenuTdActive").addClass("cssMenuTdInActive");
    $('#idSubscription').removeClass("cssMenuTdInActive");
    $('#idSubscription').addClass("cssMenuTdActive");
}

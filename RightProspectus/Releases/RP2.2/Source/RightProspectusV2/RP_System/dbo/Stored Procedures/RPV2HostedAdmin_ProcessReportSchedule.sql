...
BEGIN
	...
	SELECT 
		...
		[ReportSchedule].[UtcDataStartDate],
		[ReportSchedule].[UtcNextDataEndDate],
		[Reports].[ErrorEmailSub],
		[Reports].[ErrorEmailTemplate],
		[ReportScheduleRecipients].[ErrorEmail],
		[ReportSchedule].[UtcLastDataEndDate]
	FROM [ReportSchedule]

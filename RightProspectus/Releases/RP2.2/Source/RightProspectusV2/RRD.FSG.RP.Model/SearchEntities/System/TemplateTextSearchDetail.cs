...
namespace RRD.FSG.RP.Model.SearchEntities.System
{
    ...
    /// </summary>
    public class TemplateTextSearchDetail
        : SearchDetail<TemplateTextObjectModel>, ISearchDetailCopyAs<TemplateTextSearchDetail>
    {
        ...
        public override Func<TemplateTextObjectModel, bool> SearchPredicate
        {
            get
            {
                return entity =>
        ...
        public virtual new TCopy CopyAs<TCopy>()
            where TCopy : TemplateTextSearchDetail, new()
        {
            ...
            copy.DefaultText = this.DefaultText;
            copy.DefaultTextCompare = this.DefaultTextCompare;
            return copy;
        }

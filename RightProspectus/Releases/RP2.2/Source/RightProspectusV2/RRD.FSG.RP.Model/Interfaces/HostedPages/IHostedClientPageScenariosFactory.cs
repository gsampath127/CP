...
namespace RRD.FSG.RP.Model.Interfaces.HostedPages
{
    ...
    public interface IHostedClientPageScenariosFactory
    {
        ...
        /// <returns>TaxonomyAssociationData.</returns>
        TaxonomyAssociationData GetTaxonomyAssociationClientDocuments(string clientName, string externalID1, string externalID2,
                                                                    int? internalTAID);
        /// <summary>
        ...
        TaxonomyAssociationGroupModel GetTaxonomyAssociationGroupDocuments(string clientName, string site, int? groupId);

...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class StaticResourceFactoryCache
        : BaseFactoryCache<StaticResourceFactory, StaticResourceObjectModel, int>
    {
        #region Constructors
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StaticResourceFactoryCache" /> class.
        /// </summary>
        /// <param name="dataAccess">Data access entity used to interface between the factory and the persisted storage.</param>
        public StaticResourceFactoryCache(IDataAccess dataAccess)
            : base(new StaticResourceFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "StaticResourceFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_StaticResourceData_CacheDependencyCheck"; }
        }

...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
    public class UserFactoryCache
        : BaseFactoryCache<UserFactory, UserObjectModel, int>
    {
        #region Constructors
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserFactoryCache" /> class.
        /// </summary>
        /// <param name="dataAccess">Data access entity used to interface between the factory and the persisted storage.</param>
        public UserFactoryCache(IDataAccess dataAccess)
            : base(new UserFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "UserFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedSites_StaticUsersData_CacheDependencyCheck"; }
        }

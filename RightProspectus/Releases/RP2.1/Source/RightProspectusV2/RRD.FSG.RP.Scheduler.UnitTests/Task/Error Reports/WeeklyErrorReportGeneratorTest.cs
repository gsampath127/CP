...
namespace RRD.FSG.RP.Scheduler.UnitTests.Task.Error_Reports
{
    ...
    public class WeeklyErrorReportGeneratorTest
    {
        ...
        #region GetWeeklyErrorReportbyDate_Calls_Scheduler
        /// <summary>
        /// GetWeeklyErrorReportbyDate_Calls_Scheduler
        /// </summary>
        [TestMethod]
        public void GetWeeklyErrorReportbyDate_Calls_Scheduler()
        {
          ...
          //  var result = objDocumentTypeExternalIdFactory.GetWeeklyErrorReportbyDate(DateTime.Now,DateTime.Now);

...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class VerticalXmlImportFactoryCache : BaseFactoryCache<VerticalXmlImportFactory, VerticalXmlImportObjectModel, int>
    {
         #region Constructors
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VerticalXmlImportFactoryCache" /> class.
        /// </summary>
        /// <param name="dataAccess">Data access entity used to interface between the factory and the persisted storage.</param>
        public VerticalXmlImportFactoryCache(IDataAccess dataAccess)
            : base(new VerticalXmlImportFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "VerticalXmlImportFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_VerticalXmlImportData_CacheDependencyCheck"; }
        }

...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
    public class TemplateNavigationFactoryCache : BaseFactoryCache<TemplateNavigationFactory, TemplateNavigationObjectModel, TemplateNavigationKey>
    {
        #region Constructors
       ...
       public TemplateNavigationFactoryCache(IDataAccess dataAccess)
            : base(new TemplateNavigationFactory(dataAccess)) { }
       ...
       /// <value>The collection cache key.</value>
        ...
        {
            get { return string.Format("{0}:{1}", "TemplateSiteNavigationFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_StaticTemplateSiteNavigation_CacheDependencyCheck"; }
        }

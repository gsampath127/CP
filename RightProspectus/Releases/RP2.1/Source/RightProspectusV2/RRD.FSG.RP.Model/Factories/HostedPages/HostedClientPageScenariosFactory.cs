...
namespace RRD.FSG.RP.Model.Factories.HostedPages
{
    ...
    public class HostedClientPageScenariosFactory : HostedPageBaseFactory, IHostedClientPageScenariosFactory
    {
        ...
        public List<DocumentUpdateReportModel> GetTaxonomyAssociationforDocumentUpdateReport(string clientName, DateTime startDate, DateTime endDate)
        {
            ...
            DataTable docUpDtReportVerticalData = iHostedVerticalPageScenarios.GetDocumentUpdateReportVerticalData(endDate, clientTaxonomyIDs, clientName);
        ...
        public TaxonomyAssociationGroupModel GetTaxonomyAssociationGroupDocuments(string clientName, string site, int? groupId)
        {
            ...
            TaxonomyAssociationGroupModel taxonomyAssociationGroupModel = GetTaxonomyAssociationGroupDocumentsClientData(
                                                                         clientName, site, groupId,
                                                                        clientTaxonomyIDsWithDocTypeIDs);

            
            return iHostedVerticalPageScenarios.GetTaxonomyAssociationGroupDocumentsVerticalData(clientTaxonomyIDsWithDocTypeIDs, clientName,
                                                                                                            taxonomyAssociationGroupModel);
            
        }

        private TaxonomyAssociationGroupModel GetTaxonomyAssociationGroupDocumentsClientData(string clientName, string siteName, int? groupId, DataTable verticalIds)
        {
            ...
            DataSet results = DataAccess.ExecuteDataSet(DBConnectionString.HostedConnectionString(clientName, DataAccess),
                         SPGetTaxonomyAssociationGroups,
                          DataAccess.CreateParameter(DBCTAGID, DbType.Int32, groupId),
                          DataAccess.CreateParameter(DBCSiteName, DbType.String, siteName)
                         );
            ...
            TaxonomyAssociationGroupTaxonomyAssociationData tAGTAData = null;
            int previousTaxonomyID = -1;
            TaxonomyAssociationData taxonomyAssociationData = null;
            ...
            foreach (DataRow datarow in results.Tables[1].Rows)
            {
                ...
                {
                    tAGTAData = new TaxonomyAssociationGroupTaxonomyAssociationData();                
                    tAGTAData.TaxonomyAssociationData = new List<TaxonomyAssociationData>();
                    tAGTAData.TaxonomyAssociationGroupId = taxonomyAssociationGroupId;
                    tAGTAData.Name = datarow.Field<string>("Name"); ;

                    previousTaxonomyID = -1;
                    taxonomyAssociationData = null;

                    taxonomyAssociationGroupModel.TAGTAData.Add(tAGTAData);
                ...
                {
                    taxonomyAssociationData = new TaxonomyAssociationData();
                    tAGTAData.TaxonomyAssociationData.Add(taxonomyAssociationData);
                ...
                if (verticalIds.Select("TaxonomyID = " + taxonomyID + " AND DocumentTypeId = " + documentTypeId).Length == 0)
                {
                    verticalIds.Rows.Add(taxonomyID,
                                        taxonomyNameOverride,
                                        documentTypeId,

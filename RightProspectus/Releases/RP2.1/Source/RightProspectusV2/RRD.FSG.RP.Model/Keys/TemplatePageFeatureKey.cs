...
{
    /// <summary>
    /// Class TemplatePageFeatureKey.
    /// </summary>
    public class TemplatePageFeatureKey : IEquatable<TemplatePageFeatureKey>, IComparable<TemplatePageFeatureKey>, IComparable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:TemplatePageFeatureKey" /> class.
        /// </summary>
        /// <param name="templateId">The template identifier.</param>
        /// <param name="pageId">The page identifier.</param>
        /// <param name="featureKey">The feature key.</param>

        public TemplatePageFeatureKey(int templateId,int pageId,string featureKey)
        {
        ...
        #region Equals
        /// <summary>
        /// Compares two <see cref="TemplatePageFeatureKey" /> entities for equality.
        /// </summary>
        /// <param name="other">The other entity to compare against.</param>
        /// <returns>True if the TemplateId and TemplatePageFeatureKey are the same.</returns>
        public bool Equals(TemplatePageFeatureKey other)
        {
        ...
        /// <returns>True if the TempalteId and  TemplatePageFeatureKey are the same.</returns>
        public override bool Equals(object obj)
        {
            return this.Equals(obj as TemplatePageFeatureKey);
        }

        /// <summary>
        /// Generates a hash code for the <see cref="T:TemplatePageFeatureKey" /> entity by combining the Te and TemplatePageid properties.
        /// </summary>
        ...
        #region CompareTo
        /// <summary>
        /// Compares two <see cref="T:TemplatePageFeatureKey" /> entities by Level and Taxonomy Id
        /// </summary>
        ...
        public int CompareTo(TemplatePageFeatureKey other)
        {
        ...
        /// <param name="pageId">The page identifier.</param>
        /// <param name="featureKey">The feature key.</param>
        /// <returns>a new TemplatePageFeatureKey entity</returns>
        public static TemplatePageFeatureKey Create(int templateId,int pageId, string featureKey)
        {
            return new TemplatePageFeatureKey(templateId,pageId, featureKey);
        }
        ...
        public static bool operator >(TemplatePageFeatureKey key1, TemplatePageFeatureKey key2)
        {

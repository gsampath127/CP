...
{
    /// <summary>
    /// Class TemplatePageTextObjectModel.
    /// </summary>
    public class TemplatePageTextObjectModel : BaseModel<TemplatePageTextKey>, IComparable<TemplatePageTextObjectModel>
    {
        /// <summary>
        ...
        public override TemplatePageTextKey Key
        {
            get { return new TemplatePageTextKey(this.TemplateID, this.PageID,this.ResourceKey); }
            internal set
            {
        ...
        public int CompareTo(TemplatePageTextObjectModel other)
        {

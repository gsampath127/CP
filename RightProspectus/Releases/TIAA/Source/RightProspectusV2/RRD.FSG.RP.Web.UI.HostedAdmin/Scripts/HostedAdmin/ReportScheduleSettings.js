...
function ClearFilters() {
    $('#reportScheduleClearFilters').click(function () {
        ...
        $('#ScheduledEndDateCombo').data("kendoComboBox").text('');
...
function LoadScheduleEndDateCombo() {

    $('#ScheduledEndDateCombo').kendoComboBox({
        dataSource: {
            transport: {
                read: {//Check for the method in the Controller
                    url: $("#dvScheduledEndDateCombo").data('request-url'),
                    cache: false
                },
                type: "GET",
                dataType: "json"
    ...
    $("#ScheduledEndDateCombo").data("kendoComboBox").dataSource.read();
...
function LoadDatabySearchParameters() {
    ...
    var scheduledEndDate = $('#ScheduledEndDateCombo').data("kendoComboBox").value();
      var offset = new Date().getTimezoneOffset();
    $("#reportScheduleGridwithSortingButtons").show();
    LoadData(reportName, frequencyType, isEnabled,firstScheduleRundate, nextScheduleRunDate, scheduledEndDate, offset);
}

var initialLoad = true;
function LoadData(reportName, frequencyType,isEnabled, firstScheduleRundate, nextScheduleRunDate, scheduledEndDate, offset) {
    ...
    $("#reportScheduleGrid").kendoGrid({
        ...
        columns: [
                  ...
                  { field: "UtcFirstScheduledRunDate", title: "Scheduled Run Date" },
                  { field: "UtcLastActualRunDate", title: "Last Actual Run Date" },
                  { field: "UtcNextScheduledRunDate", title: "Next Scheduled Run Date" },
                  { field: "UtcScheduledEndDate", title: "Scheduled End Date" },
                  { field: "FrequencyDescription", title: "Frequency Description" },

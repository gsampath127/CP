...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class SiteFeatureFactoryCache
        : BaseFactoryCache<SiteFeatureFactory, SiteFeatureObjectModel, SiteFeatureKey>

    {
        ...
        public SiteFeatureFactoryCache(IDataAccess dataAccess)
            : base(new SiteFeatureFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "SiteFeatureFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_SiteFeature_CacheDependencyCheck"; }
        }
        /// <summary>

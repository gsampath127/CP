...
namespace RRD.FSG.RP.Model.Cache.VerticalMarket
{
    ...
    /// </summary>
    public class DocumentTypeFactoryCache
        : BaseFactoryCache<DocumentTypeFactory, DocumentTypeObjectModel, int>
    {
        #region Constructors
        ...
        public DocumentTypeFactoryCache(IDataAccess dataAccess)
            : base(new DocumentTypeFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "DocumentTypeFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_DocumentTypeData_CacheDependencyCheck"; }
        }

...
CREATE TABLE [dbo].[Clients] (
	...
	[IsClientDocumentsAvailableFromFTP] bit CONSTRAINT [DF_Clients_IsClientDocumentsAvailableFromFTP] DEFAULT (0) NOT NULL
...
CREATE TABLE [dbo].[ReportScheduleRecipients] (
    ...
    [ModifiedBy]       INT            NULL,
	[IsSFTP] BIT CONSTRAINT [DF_ReportScheduleRecipients_IsSFTP] DEFAULT (0) NOT NULL,

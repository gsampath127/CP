...
namespace RRD.FSG.RP.Model.SearchEntities.System
{
    ...
    /// </summary>
    public class TemplatePageFeatureSearchDetail
        : SearchDetail<TemplatePageFeatureObjectModel>, ISearchDetailCopyAs<TemplatePageFeatureSearchDetail>
    {
        ...
        public override Func<TemplatePageFeatureObjectModel, bool> SearchPredicate
        {
            get
            {
                return entity =>
        ...
        public virtual new TCopy CopyAs<TCopy>()
            where TCopy : TemplatePageFeatureSearchDetail, new()
        {

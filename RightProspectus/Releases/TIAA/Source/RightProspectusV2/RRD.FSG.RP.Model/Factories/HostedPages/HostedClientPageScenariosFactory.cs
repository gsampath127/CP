...
namespace RRD.FSG.RP.Model.Factories.HostedPages
{
    ...
    public class HostedClientPageScenariosFactory : HostedPageBaseFactory, IHostedClientPageScenariosFactory
    {
        ...
        /// <param name="verticalIds">The vertical ids.</param>
        /// <returns>TaxonomyAssociationData.</returns>
        public TaxonomyAssociationData GetTaxonomyAssociationClientDocuments(string clientName, string externalID1, string externalID2,
                                                                    int? internalTAID)
        {
            DataTable clientTaxonomyIDs = new DataTable();
        ...
        /// <param name="verticalIds">The vertical ids.</param>
        /// <returns>TaxonomyAssociationData.</returns>
        private TaxonomyAssociationData GetTaxonomyAssociationClientDocumentsDetails(string clientName, string externalID1, string externalID2, int? internalTAID, DataTable verticalIds)
        {
            TaxonomyAssociationData taxonomyAssociationData = null;
        ...
        public TaxonomyAssociationGroupModel GetTaxonomyAssociationGroupDocuments(string clientName, string site, int? groupId)
        {
            return GetTaxonomyAssociationGroupDocumentsClientData(clientName, site, groupId);
        }

        private TaxonomyAssociationGroupModel GetTaxonomyAssociationGroupDocumentsClientData(string clientName, string siteName, int? groupId)
        {
            DataTable clientTaxonomyIDsWithDocTypeIDs = new DataTable();
            ...
            foreach (DataRow datarow in results.Tables[0].Rows)
            {
                ...
                if (datarow.Field<int?>("TaxonomyAssociationId") != null)
                {
                    ...
                    if (previousTaxonomyAssociationId != taxonomyAssociationId)
                    {
                        ...
                        taxonomyAssociationData.TaxonomyOrder = datarow.Field<int>("TaxonomyOrder");

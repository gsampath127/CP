...
namespace RRD.FSG.RP.Model.Factories
{
    ...
    public static class DBConnectionString
    {
        ...
        public static string VerticalDBConnectionString(string clientName, IDataAccess dataAccess)
        {
            ...
            //code required to get string from Cache or from the System
            ClientDbConnection clientDataSystemModel = null;
            if(string.IsNullOrWhiteSpace(clientName))
            {
                clientDataSystemModel = clientDataSystemModels.FirstOrDefault();
            }
            else
            {
                clientDataSystemModel = clientDataSystemModels.Find(c => c.ClientName.ToLower() == clientName.ToLower());
            }            

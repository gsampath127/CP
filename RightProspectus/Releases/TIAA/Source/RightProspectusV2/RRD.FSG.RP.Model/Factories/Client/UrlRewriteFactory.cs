...
namespace RRD.FSG.RP.Model.Factories.Client
{
    ...
    /// </summary>
    public class UrlRewriteFactory : AuditedBaseFactory<UrlRewriteObjectModel, int>
    {
        #region Constants
        /// <summary>
        /// declaration of all Strings/Procedures used as constants
        /// </summary>
        private const string SPGetAllUrlRewrite = "RPV2HostedAdmin_GetAllUrlRewrite";
        /// <summary>
        /// The sp save PageText
        /// </summary>
        private const string SPSaveUrlRewrite = "RPV2HostedAdmin_SaveUrlRewrite";
        /// <summary>
        /// The sp deletes PageText
        /// </summary>
        private const string SPDeleteUrlRewrite = "RPV2HostedAdmin_DeleteUrlRewrite";


        /// <summary>
        /// UrlRewriteId
        /// </summary>
        private const string DBCUrlRewriteId = "UrlRewriteId";
        /// <summary>
        /// MatchPattern
        /// </summary>
        private const string DBCMatchPattern = "MatchPattern";
        /// <summary>
        /// RewriteFormat
        /// </summary>
        private const string DBCRewriteFormat = "RewriteFormat";
        /// <summary>
        /// PatternName
        /// </summary>
        private const string DBCPatternName = "PatternName";
        #endregion
        ...
        public UrlRewriteFactory(IDataAccess dataAccess)
            : base(dataAccess) { }
        #endregion
        ...
        public override UrlRewriteObjectModel GetEntityByKey(int key)
        {
            return GetUrlRewriteEntity(key);
        }
        ...
        public UrlRewriteObjectModel GetUrlRewriteEntity(int key)
        {
        ...
        {
            return this.GetEntitiesInternal<TEntity>(SPGetAllUrlRewrite, startRowIndex, maximumRows, null);
        }
        ...
        {
            return this.GetEntitiesInternal<TEntity>(SPGetAllUrlRewrite, startRowIndex, maximumRows, sort);
        }
        ...
        public override TEntity CreateEntity<TEntity>(DataRow entityRow)
        {
            ...
            if (entity != null)
            {
                ...
                entity.UrlRewriteId = entityRow.Field<int>(DBCUrlRewriteId);
                entity.Key = entity.UrlRewriteId;
                entity.MatchPattern = entityRow.Field<string>(DBCMatchPattern);
                entity.RewriteFormat = entityRow.Field<string>(DBCRewriteFormat);
                entity.PatternName = entityRow.Field<string>(DBCPatternName);
            }
        ...
        public override void SaveEntity(UrlRewriteObjectModel entity)
        {
            List<DbParameter> parameters = base.GetParametersFromEntity<UrlRewriteObjectModel>(entity) as List<DbParameter>;

            if (parameters != null)
            {
                parameters.Add(DataAccess.CreateParameter(DBCUrlRewriteId, DbType.Int32, entity.UrlRewriteId));
                parameters.Add(DataAccess.CreateParameter(DBCMatchPattern, DbType.String, entity.MatchPattern));
                parameters.Add(DataAccess.CreateParameter(DBCRewriteFormat, DbType.String, entity.RewriteFormat));
                parameters.Add(DataAccess.CreateParameter(DBCPatternName, DbType.String, entity.PatternName));


                DataAccess.ExecuteNonQuery(this.ConnectionString, SPSaveUrlRewrite, parameters);
            }
        }
        ...
        public override void SaveEntity(UrlRewriteObjectModel entity, int modifiedBy)
        {
        ...
        public override void DeleteEntity(int key, int deletedBy)
        {
            ...
            if (parameters != null)
            {
                parameters.Add(DataAccess.CreateParameter(DBCUrlRewriteId, DbType.Int32, key));
                DataAccess.ExecuteNonQuery(this.ConnectionString, SPDeleteUrlRewrite, parameters);
            }
        }
        ...
        public override void DeleteEntity(UrlRewriteObjectModel entity)
        {
        ...
        /// <param name="deletedBy">The deleted by.</param>
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(UrlRewriteObjectModel entity, int deletedBy)
        {
            throw new NotImplementedException();
        }

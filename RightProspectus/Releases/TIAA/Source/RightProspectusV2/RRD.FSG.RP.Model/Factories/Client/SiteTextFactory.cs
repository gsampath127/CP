...
{
    /// <summary>
    /// SiteTextFactory class factory to handle all SiteText module operations
    /// </summary>
    public class SiteTextFactory : AuditedBaseFactory<SiteTextObjectModel, SiteTextKey>
    {
        #region Constants
        /// <summary>
        /// declaration of all Strings/Procedures used as constants
        /// </summary>
        private const string SPGetAllSiteText = "RPV2HostedAdmin_GetAllSiteText";

        /// <summary>
        /// The sp save PageText
        /// </summary>
        private const string SPSaveSiteText = "RPV2HostedAdmin_SaveSiteText";

        /// <summary>
        /// The sp deletes PageText
        /// </summary>
        private const string SPDeleteSiteText = "RPV2HostedAdmin_DeleteSiteText";


        /// <summary>
        /// SiteTextId
        /// </summary>
        private const string DBCSiteTextId = "SiteTextId";
        ...
        /// <summary>
        /// IsProofingAvailableForSiteTextID
        /// </summary>
        private const string DBCIsProofingAvailableForSiteTextID = "IsProofingAvailableForSiteTextID";
        ...
        public SiteTextFactory(IDataAccess dataAccess)
            : base(dataAccess) { }
        #endregion
        ...
        public override SiteTextObjectModel GetEntityByKey(SiteTextKey key)
        {
            return GetSiteTextEntity(key);
        }
        ...
        public SiteTextObjectModel GetSiteTextEntity(SiteTextKey key)
        {
        ...
        {
            return this.GetEntitiesInternal<TEntity>(SPGetAllSiteText, startRowIndex, maximumRows,null);
        }
        ...
        {
            return this.GetEntitiesInternal<TEntity>(SPGetAllSiteText, startRowIndex, maximumRows, sort);
        }
        ...
        public override TEntity CreateEntity<TEntity>(DataRow entityRow)
        {
            ...
            if (entity != null)
            {
                ...
                entity.SiteTextID = entityRow.Field<int>(DBCSiteTextId);
                ...
                entity.IsProofingAvailableForSiteTextId = entityRow.Field<bool>(DBCIsProofingAvailableForSiteTextID);
            }
        ...
        public override void SaveEntity(SiteTextObjectModel entity)
        {
            List<DbParameter> parameters = base.GetParametersFromEntity<SiteTextObjectModel>(entity) as List<DbParameter>;

            if (parameters != null)
            {
                parameters.Add(DataAccess.CreateParameter(DBCSiteTextId, DbType.Int32, entity.SiteTextID));
                ...
                DataAccess.ExecuteNonQuery(this.ConnectionString, SPSaveSiteText, parameters);
            }
        }
        ...
        public override void SaveEntity(SiteTextObjectModel entity, int modifiedBy)
        {
        ...
        /// <returns>A new instance of type <typeparamref name="TModel" /> if found. Null otherwise.</returns>
        /// <exception cref="System.NotImplementedException"></exception>
        public override TEntity GetEntityByKey<TEntity>(SiteTextKey key)
        {
            throw new NotImplementedException();
        }
        ...
        public override void DeleteEntity(SiteTextKey key)
        {
            DeleteEntity(key);
        }
        ...
        /// <param name="modifiedBy">The modified by.</param>
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(SiteTextKey key, int modifiedBy)
        {
            throw new NotImplementedException();
        }
        ...
        public override void DeleteEntity(SiteTextObjectModel entity)
        {
        ...
        public override void DeleteEntity(SiteTextObjectModel entity, int deletedBy)
        {
            ...
            if (parameters != null)
            {
                ...
                DataAccess.ExecuteNonQuery(this.ConnectionString, SPDeleteSiteText, parameters);
            }
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override IEnumerable<TEntity> GetEntitiesBySearch<TEntity>(int startRowIndex, int maximumRows, ISearchDetail<TEntity> search, ISortDetail<TEntity> sort, out int totalRecordCount, params SiteTextKey[] entitiesToIgnore)
        {
            throw new NotImplementedException();
        }
    }

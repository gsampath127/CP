...
{
    /// <summary>
    /// Class TemplateNavigationFactory.
    /// </summary>
    public class TemplateNavigationFactory : BaseFactory<TemplateNavigationObjectModel, TemplateNavigationKey>
    {
        #region Constants
        /// <summary>
        /// The sp get all Template Page
        /// </summary>
        private const string SPGetAllTemplatePageText = "RPV2HostedAdmin_GetAllTemplateSiteNavigation";
        ...
        public TemplateNavigationFactory(IDataAccess dataAccess)
            : base(dataAccess)
        {
        ...
        public override TEntity GetEntityByKey<TEntity>(TemplateNavigationKey key)
        {
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void SaveEntity(TemplateNavigationObjectModel entity)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(TemplateNavigationKey key)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void SaveEntity(TemplateNavigationObjectModel entity, int modifiedBy)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="modifiedBy">The modified by.</param>
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(TemplateNavigationKey key, int modifiedBy)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(TemplateNavigationObjectModel entity)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override void DeleteEntity(TemplateNavigationObjectModel entity, int deletedBy)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="System.NotImplementedException"></exception>
        public override IEnumerable<TEntity> GetEntitiesBySearch<TEntity>(int startRowIndex, int maximumRows, ISearchDetail<TEntity> search, ISortDetail<TEntity> sort, out int totalRecordCount, params TemplateNavigationKey[] entitiesToIgnore)
        {
            throw new NotImplementedException();
        }
    }

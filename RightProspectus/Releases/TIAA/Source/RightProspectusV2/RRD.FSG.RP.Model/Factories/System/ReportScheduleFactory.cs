...
namespace RRD.FSG.RP.Model.Factories.System
{
    ...
    public class ReportScheduleFactory : AuditedBaseFactory<ReportScheduleObjectModel, int>
    {
        ...
        /// The DBC frequency interval
        /// </summary>
        private const string DBCErrorEmail = "ErrorEmail";
        /// <summary>
        ...
        /// <summary>
        /// The DBC UTC data Start date
        /// </summary>
        private const string DBCUtcDataStartDate = "UtcDataStartDate";
        /// <summary>
        /// The DBC UTC data End date
        /// </summary>
        private const string DBCUtcDataEndDate = "UtcDataEndDate";
        /// <summary>
        /// The DBC UTC Scheduled End date
        /// </summary>
        private const string DBCUtcScheduledEndDate = "UtcScheduledEndDate";

        /// <summary>
        /// Week Days
        /// </summary>
        private const string DBCWeekDays = "WeekDays";
        ...
        public override TEntity GetEntityByKey<TEntity>(int key)
        {
            ...
            if (result.Rows.Count > 0)
            {
                ...
                {
                    result.Rows[i][27] = "GetEntityByKey";
                }
        ...
        public override IEnumerable<TEntity> GetEntitiesBySearch<TEntity>(int startRowIndex, int maximumRows, ISearchDetail<TEntity> search, ISortDetail<TEntity> sort, out int totalRecordCount, params int[] entitiesToIgnore)
        {
            ...
            if (maximumRows > 0)
            {
                ...
                if (parameters != null)
                {
                    ...
                    //parameters.Add(DataAccess.CreateParameter(DBCFrequencyDescription, DbType.String, searchDetails.FrequencyDescription));                 
                    ...
                    parameters.Add(DataAccess.CreateParameter(DBCUtcScheduledEndDate, DbType.DateTime, searchDetails.ScheduledEndDate));
                    ...
                    {
                        result.Tables[0].Rows[i][16] = "GetEntitiesBySearch";
                    }
            ...
            else
            {
                ...
                for (int i = 0; i < result.Rows.Count; i++)
                {
                    result.Rows[i][12] = "GetAllEntities";
                }
                return this.CreateEntities<TEntity>(result);
            }
        }
        ...
        public override void SaveEntity(ReportScheduleObjectModel entity)
        {
            ...
            if (parameters != null)
            {
               ...
               // parameters.Add(DataAccess.CreateParameter(DBCIsEnabled, DbType.Boolean, entity.IsEnabled));
                ...
                parameters.Add(DataAccess.CreateParameter(DBCErrorEmail, DbType.String, entity.ErrorEmail));
                parameters.Add(DataAccess.CreateParameter(DBCUtcDataStartDate, DbType.DateTime, entity.UtcDataStartDate));
                parameters.Add(DataAccess.CreateParameter(DBCUtcDataEndDate, DbType.DateTime, entity.UtcDataEndDate));
                parameters.Add(DataAccess.CreateParameter(DBCUtcScheduledEndDate, DbType.DateTime, entity.UtcScheduledEndDate));
                parameters.Add(DataAccess.CreateParameter(DBCWeekDays, DbType.String, entity.WeekDays));
            ...
            if (entity != null)
            {
                switch (entityRow.Field<string>("Entity"))
                {
                    case "GetAllEntities":
                        ...
                        entity.UtcScheduledEndDate = entityRow.Field<DateTime?>(DBCUtcScheduledEndDate);
                        break;
                    ...
                    //    entity.IsEnabled = entityRow.Field<bool>(DBCIsEnabled);
                        ...
                        entity.UtcDataStartDate = entityRow.Field<DateTime?>(DBCUtcDataStartDate);
                        entity.UtcDataEndDate = entityRow.Field<DateTime?>(DBCUtcDataEndDate);
                        entity.UtcScheduledEndDate = entityRow.Field<DateTime?>(DBCUtcScheduledEndDate);
                        entity.WeekDays = entityRow.Field<string>(DBCWeekDays);
                        entity.ErrorEmail = entityRow.Field<string>(DBCErrorEmail);
                        break;
                    case "GetAllReports":
                        entity.ReportId = entityRow.Field<int>(DBCReportId);
                        entity.ReportName = entityRow.Field<string>(DBCReportName);

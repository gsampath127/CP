$(document).ready(function () {
    ...
    $('#ClientDocumentTypePopOver').popover({
        ...
        placement: 'right',
        html: 'true',
        title: '<span class="text-info"><strong>Taxonomy Level External</strong></span> <button type="button" id="close" class="close" onclick="ClosePopOver(&apos;ClientDocumentTypePopOver&apos;)">&times;</button></span>',

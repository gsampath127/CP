...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class SiteFactoryCache
        : BaseFactoryCache<SiteFactory, SiteObjectModel, int>
    {
        #region Constructors
        ...
        public SiteFactoryCache(IDataAccess dataAccess)
            : base(new SiteFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "SiteFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_SiteData_CacheDependencyCheck"; }
        }

...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class UrlRewriteFactoryCache
        : BaseFactoryCache<UrlRewriteFactory, UrlRewriteObjectModel, int>
    {
        #region Constructors
        ...
        public UrlRewriteFactoryCache(IDataAccess dataAccess)
            : base(new UrlRewriteFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "UrlRewriteFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_UrlRewriteData_CacheDependencyCheck"; }
        }

...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class DocumentTypeExternalIdFactoryCache
        : BaseFactoryCache<DocumentTypeExternalIdFactory, DocumentTypeExternalIdObjectModel, DocumentTypeExternalIdKey>
    {
        #region Constructors
        ...
        public DocumentTypeExternalIdFactoryCache(IDataAccess dataAccess)
            : base(new DocumentTypeExternalIdFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "DocumentTypeExternalIdFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_DocumentTypeExternalIdData_CacheDependencyCheck"; }
        }

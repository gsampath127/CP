...
namespace RRD.FSG.RP.Model.Cache.Client
{
    ...
    /// </summary>
    public class TaxonomyLevelExternalIdFactoryCache
        : BaseFactoryCache<TaxonomyLevelExternalIdFactory, TaxonomyLevelExternalIdObjectModel, TaxonomyLevelExternalIdKey>
    {
        #region Constructors
        ...
        public TaxonomyLevelExternalIdFactoryCache(IDataAccess dataAccess)
            : base(new TaxonomyLevelExternalIdFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "TaxonomyLevelExternalIdFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_TaxonomyLevelExternalIdData_CacheDependencyCheck"; }
        }

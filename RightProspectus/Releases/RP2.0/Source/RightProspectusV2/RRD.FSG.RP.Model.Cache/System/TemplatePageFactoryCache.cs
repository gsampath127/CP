...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
    public class TemplatePageFactoryCache
        : BaseFactoryCache<TemplatePageFactory, TemplatePageObjectModel, TemplatePageKey>
    {
        #region Constructors
        ...
        public TemplatePageFactoryCache(IDataAccess dataAccess)
            : base(new TemplatePageFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "TemplatePageFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_StaticTemplatePage_CacheDependencyCheck"; }
        }

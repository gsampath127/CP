...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
    public class ClientFactoryCache
        : BaseFactoryCache<ClientFactory, ClientObjectModel, int>
    {
        #region Constructors
        ...
        public ClientFactoryCache(IDataAccess dataAccess)
            : base(new ClientFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "ClientFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedSites_StaticClientsData_CacheDependencyCheck"; }
        }

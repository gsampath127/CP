...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
    public class TemplatePageTextFactoryCache
        : BaseFactoryCache<TemplatePageTextFactory, TemplatePageTextObjectModel, TemplatePageTextKey>
    {
        #region Constructors
        ...
        public TemplatePageTextFactoryCache(IDataAccess dataAccess)
            : base(new TemplatePageTextFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "TemplatePageTextFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_StaticTemplatePageText_CacheDependencyCheck"; }
        }

...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
   public class ReportScheduleFactoryCache
        : BaseFactoryCache<ReportScheduleFactory, ReportScheduleObjectModel, int>
    {
        #region Constructors
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportScheduleFactoryCache" /> class.
        /// </summary>
        /// <param name="dataAccess">Data access entity used to interface between the factory and the persisted storage.</param>
        public ReportScheduleFactoryCache(IDataAccess dataAccess)
            : base(new ReportScheduleFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "ReportScheduleFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_ReportScheduleData_CacheDependencyCheck"; }
        }

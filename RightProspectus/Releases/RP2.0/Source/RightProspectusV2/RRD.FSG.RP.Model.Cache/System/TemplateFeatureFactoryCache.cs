...
namespace RRD.FSG.RP.Model.Cache.System
{
    ...
    /// </summary>
    public class TemplateFeatureFactoryCache
         : BaseFactoryCache<TemplateFeatureFactory, TemplateFeatureObjectModel, TemplateFeatureKey>
    {
        ...
        public TemplateFeatureFactoryCache(IDataAccess dataAccess)
            : base(new TemplateFeatureFactory(dataAccess)) { }
        ...
        {
            get { return string.Format("{0}:{1}", "TemplateFeatureFactoryCacheKey", (this.Factory.ConnectionString ?? string.Empty).GetHashCode()); }
        }
        ...
        {
            get { return "RPV2HostedAdmin_StaticTemplateFeature_CacheDependencyCheck"; }
        }

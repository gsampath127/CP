    ...
    function ($stateProvider, $urlRouterProvider, $locationProvider, cfpLoadingBarProvider, USER_ROLES, AUTH_EVENTS) {
        ...
        .state('MissingReport', {
            ...
            views: {
                ...
                'body': {
                    templateUrl: 'Public/views/reports/missingReport.html',
         ...
         .state('securityTypes', {
             url: '/securityTypeReport',
             views: {
                 'header': {
                     templateUrl: 'Public/views/login/header.html'
                 },
                 'body': {
                     templateUrl: 'Public/views/reports/securityTypes.html',
                     controller: 'SecurityTypeReportCtrl'
        ...
        .state('EonlineFeed', {
            ...
            views: {
                ...
                'body': {
                    templateUrl: 'Public/views/reports/EonlineFeed.html',
                    controller: 'EonlineFeedReportCtrl'
        ...
        .state('edgarOnlineData', {
            ...
            views: {
                ...
                'body': {
                    templateUrl: 'Public/views/reports/edgarOnlineData.html',
                    controller: 'EdgarOnlineDataCtrl'
                }
            },
            data: {
                authorizedRoles: [USER_ROLES.SuperAdmin, USER_ROLES.GIMUser,
         ...
         .state('rpMissingCusip', {
             ...
             views: {
                 ...
                 'body': {
                     templateUrl: 'Public/views/reports/rpMissingCusip.html',
                     controller: 'RPMissingCusipCtrl'
                 }
             },
             data: {
                 authorizedRoles: [USER_ROLES.SuperAdmin, USER_ROLES.GIMUser,

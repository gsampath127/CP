...
/****** Object:  StoredProcedure [dbo].[BCS_AllianceBernsteinGetSLINKReportDetails]    Script Date: 11/14/2013 16:55:41 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BCS_AllianceBernsteinGetSLINKReportDetails]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[BCS_AllianceBernsteinGetSLINKReportDetails]
GO  
    
CREATE Procedure [dbo].[BCS_AllianceBernsteinGetSLINKReportDetails]
...
SELECT * FROM(
	...
	INNER JOIN BCSAllianceBernsteinWatchListCUSIPs ON BCSDocUpdateSupplements.CUSIP = BCSAllianceBernsteinWatchListCUSIPs.CUSIP
	...
	INNER JOIN BCSAllianceBernsteinWatchListCUSIPs ON BCSDocUpdateARSAR.CUSIP = BCSAllianceBernsteinWatchListCUSIPs.CUSIP
